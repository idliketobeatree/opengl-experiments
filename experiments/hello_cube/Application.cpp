...
void Application::init() {
	...
	this->window = glfwCreateWindow(this->windowWidth, this->windowHeight, "Hello Cube", NULL, NULL);
...
void Application::loop() {
	...
	projection = glm::perspective(glm::radians(70.0f), static_cast<float>(framebufferWidth) / static_cast<float>(framebufferHeight), 0.1f, 100.0f);
	...
	glm::mat4 mvp = projection * view * glm::rotate(glm::rotate(glm::mat4(1), static_cast<float>(frame) / 40, glm::vec3(1, 0, 0)), static_cast<float>(frame) / 20, glm::vec3(0, 1, 0));
